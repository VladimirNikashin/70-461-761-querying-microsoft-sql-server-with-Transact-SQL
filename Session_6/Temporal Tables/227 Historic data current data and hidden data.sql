...
-- To Select Temporal data between a range of times do the following:
SELECT * FROM dbo.tblEmployeeTemporal
FOR SYSTEM_TIME AS OF '2020-02-01'

SELECT * FROM dbo.tblEmployeeTemporal
FOR SYSTEM_TIME 
FROM '2019-01-01' TO '2020-01-01' -- -- This looks at historic data and current data and it excludes an enddate
WHERE EmployeeNumber = 124

SELECT * FROM dbo.tblEmployeeTemporal
FOR SYSTEM_TIME 
BETWEEN '2019-01-01' AND '2020-01-01 23:59:59.999' -- This looks at historic data and current data and it includes an enddate
WHERE EmployeeNumber = 124

SELECT * FROM dbo.tblEmployeeTemporal
FOR SYSTEM_TIME 
CONTAINED IN ('2019-01-01', '2024-01-01') -- This only looks at historic data not current data
WHERE EmployeeNumber = 124
